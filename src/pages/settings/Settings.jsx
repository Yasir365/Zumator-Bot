...
export default function Settings() {
  ...
  return (
    <div className="settings-pages">
      ...
      <div className="modal fade-up text-center" id="deleteModal" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div className="modal-dialog">
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <button type="button" className="btn" onClick={() => deleteAccount()}>
                {t("Sure")}
              </button>
            </div>
          </div>
